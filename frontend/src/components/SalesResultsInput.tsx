      ...
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="space-y-2">
            <Label htmlFor="valorFechamento" className="text-sm">
          ...
          <div className="space-y-2">
            <Label htmlFor="orcamentoAberto" className="text-sm">
              Orçamento em Aberto (R$)
            </Label>
            <Input
              id="orcamentoAberto"
              type="number"
          ...
          <div className="space-y-2">
            <Label htmlFor="leadsPerdidos" className="text-sm">
              Leads Perdidos
            </Label>
            <Input
              id="leadsPerdidos"
        ...
        <div className="mt-4 space-y-2">
          <Label htmlFor="motivoPerdido" className="text-sm">
            Motivo do Perdido
          </Label>
          <Textarea
            id="motivoPerdido"
